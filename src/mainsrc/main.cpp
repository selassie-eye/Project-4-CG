...
// for example the first entry would be  char *cmapFiles[6] = { ". ",
...
void LoadCubeFace(GLenum target, char *filename, unsigned int num)
{
	...
	const STImage* image = new STImage(filename);
	...
	printf("Activating Textures...\n");
	glActiveTexture(GL_TEXTURE0);
	
	printf("Binding textures...\n");
	glBindTexture(GL_TEXTURE_CUBE_MAP, textureID);
	
	printf("Building 2D mipmaps...\n");
    gluBuild2DMipmaps(target, 1, width, height, GL_RGBA_MODE, GL_UNSIGNED_BYTE, pixels);
}
...
void drawskybox(){
        ...
        glBindTexture(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, skybox[3]);
        glBegin(GL_QUADS);
...
void GenerateCubeMap(void)
{
    ...
    // 4. Call the function GenerateTextureCoordinates() to set the texture coordinates
    // 5. Call the function SetTextureWrapFlags() to set the parameters for how to warp the texture

    //--------------------------------------------------------------------
    printf("Loading cube faces...\n");
    for (unsigned int i = 0; i < 6; i++){ 
		LoadCubeFace(CubeFaceTarget[i], cmapFiles[i], i); 
	}
	
	printf("Adding texture parameters...\n");	
    glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
	glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	
	printf("Enabling texture cube map...\n");
	glEnable(GL_TEXTURE_CUBE_MAP);
	
	printf("Generating Texture coordinates...\n");
	GenerateTextureCoordinates();  
	
	printf("Setting texture wrap flags...\n");
	SetTextureWrapFlags();
    //-------------------------------------------------------------------------
...
void SetUpEnvironmentMap(void)
{
    ...
    printf("Initializing environment map shader...\n");
    ...
    printf("Initializing reflectance shader...\n");
...
void Setup()
{
    ...
    printf("Setting up environment map...\n");
    SetUpEnvironmentMap();
...
void ReflectanceMapping(void)
{
    ...
    // and draws the model.
    // If the left mouse button is down: displayangle, displayaxsisx, displayaxisy, displayaxisz
